...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "exports" (
  	...
  	"prefix" varchar DEFAULT 'exports',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"url" varchar,
  	"thumbnail_u_r_l" varchar,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_rels" ADD CONSTRAINT "pages_rels_taxonomy_fk" FOREIGN KEY ("taxonomy_id") REFERENCES "public"."taxonomy"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_rels" ADD CONSTRAINT "_pages_v_rels_taxonomy_fk" FOREIGN KEY ("taxonomy_id") REFERENCES "public"."taxonomy"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_posts_v_rels" ADD CONSTRAINT "_posts_v_rels_taxonomy_fk" FOREIGN KEY ("taxonomy_id") REFERENCES "public"."taxonomy"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_rels_taxonomy_id_idx" ON "pages_rels" USING btree ("taxonomy_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_rels_taxonomy_id_idx" ON "_pages_v_rels" USING btree ("taxonomy_id");
  ...
  CREATE INDEX IF NOT EXISTS "posts_rels_taxonomy_id_idx" ON "posts_rels" USING btree ("taxonomy_id");
  ...
  CREATE INDEX IF NOT EXISTS "_posts_v_rels_taxonomy_id_idx" ON "_posts_v_rels" USING btree ("taxonomy_id");
